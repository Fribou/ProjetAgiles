 ...
 * @author davy
 */
public class niv1Q5 extends javax.swing.JFrame {

    /**
     * Creates new form niv1Q5
     */
    ...
    private  void question(){
        ...
        n5=nombre;
        if(nombre==1 && n1!=1 && n2!=1 && n3!=1 && n4!=1){
            jQ5.setText(question1);
            reponse=rep1;
        }
        else if(nombre==2 && n1!=2 && n2!=2 && n3!=2 && n4!=2){
            jQ5.setText(question2);
            reponse=rep2;
        }
        else if(nombre==3 && n1!=3 && n2!=3 && n3!=3 && n4!=3){
            jQ5.setText(question3);
            reponse=rep3;
        }
        else if(nombre==4 && n1!=4 && n2!=4 && n3!=4 && n4!=4){
            jQ5.setText(question4);
            reponse=rep4;
        }
        else if(nombre==5 && n1!=5 && n2!=5 && n3!=5 && n4!=5){
            jQ5.setText(question5);
            reponse=rep5;
        }
        else if(nombre==6 && n1!=6 && n2!=6 && n3!=6 && n4!=6){
            jQ5.setText(question6);
            reponse=rep6;
        }
        else if(nombre==7 && n1!=7 && n2!=7 && n3!=7 && n4!=7){
            jQ5.setText(question7);
            reponse=rep7;
        }
        else if(nombre==8 && n1!=8 && n2!=8 && n3!=8 && n4!=8){
            jQ5.setText(question8);
            reponse=rep8;
        }
        else if(nombre==9 && n1!=9 && n2!=9 && n3!=9 && n4!=9){
            jQ5.setText(question9);
            reponse=rep9;
        }
        else if(nombre==10 && n1!=10 && n2!=10 && n3!=10 && n4!=10){
            jQ5.setText(question10);
            reponse=rep10;
        }
        else{
            question();
    ...
    private void initComponents() {
        ...
        jQ5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jQ5.setText("jLabel3");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(jQ5, javax.swing.GroupLayout.PREFERRED_SIZE, 791, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup()
                .addGap(312, 312, 312)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(niv1Q5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
