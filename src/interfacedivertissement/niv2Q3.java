 ...
 * @author davy
 */
public class niv2Q3 extends javax.swing.JFrame {

    /**
     * Creates new form niv2Q3
     */
    String reponse;
    ...
    public niv2Q3() {
     ...
     private  void question(){
        ...
        n13=nombre;
        if(nombre==1 && n11!=1 && n12!=1){
            jQ3.setText(question11);
            reponse=rep11;
        }
        else if(nombre==2 && n11!=2 && n12!=2){
            jQ3.setText(question12);
            reponse=rep12;
        }
        else if(nombre==3 && n11!=3 && n12!=3){
            jQ3.setText(question13);
            reponse=rep13;
        }
        else if(nombre==4 && n11!=4 && n12!=4){
            jQ3.setText(question14);
            reponse=rep14;
        }
        else if(nombre==5 && n11!=5 && n12!=5){
            jQ3.setText(question15);
            reponse=rep15;
        }
        else if(nombre==6 && n11!=6 && n12!=6){
            jQ3.setText(question16);
            reponse=rep16;
        }
        else if(nombre==7 && n11!=7 && n12!=7){
            jQ3.setText(question17);
            reponse=rep17;
        }
        else if(nombre==8 && n11!=8 && n12!=8){
            jQ3.setText(question18);
            reponse=rep18;
        }
        else if(nombre==9 && n11!=9 && n12!=9){
            jQ3.setText(question19);
            reponse=rep19;
        }
        else if(nombre==10 && n11!=10 && n12!=10){
            jQ3.setText(question20);
            reponse=rep20;
        }else if(nombre==11 && n11!=11 && n12!=11){
            jQ3.setText(question21);
            reponse=rep21;
        }
        else if(nombre==12 && n11!=12 && n12!=12){
            jQ3.setText(question22);
            reponse=rep22;
        }else if(nombre==13 && n11!=13 && n12!=13){
            jQ3.setText(question23);
            reponse=rep23;
        }else if(nombre==14 && n11!=14 && n12!=14){
            jQ3.setText(question24);
            reponse=rep24;
        }
        else if(nombre==15 && n11!=15 && n12!=15){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(niv2Q3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
