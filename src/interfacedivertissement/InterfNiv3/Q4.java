...
public class Q4 extends javax.swing.JFrame {
    ...
    private  void question(){
        ...
        if(nombre==1 && num1!=1 && num2!=1 && num3!=1){
         ...
         else if(nombre==10 && num1!=10 && num2!=10 && num3!=10){
         ...
         else if(nombre==11 && num1!=11 && num2!=11 && num3!=11){
         ...
         else if(nombre==12 && num1!=12 && num2!=12 && num3!=12){
         ...
         else if(nombre==13 && num1!=13 && num2!=13 && num3!=13){
         ...
         else if(nombre==14 && num1!=14 && num2!=14 && num3!=14){
         ...
         else if(nombre==15 && num1!=15 && num2!=15 && num3!=15){
         ...
         else if(nombre==16 && num1!=16 && num2!=16 && num3!=16){
         ...
         else if(nombre==17 && num1!=17 && num2!=17 && num3!=17){
