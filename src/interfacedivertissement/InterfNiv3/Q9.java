...
public class Q9 extends javax.swing.JFrame {
    ...
    private  void question(){
        ...
        num9=nombre;
        if(nombre==1 && num1!=1 && num2!=1 && num3!=1 && num4!=1 && num5!=1 && num6!=1 && num7!=1 && num8!=1){
            jQ1.setText(question1);
            reponse=reponse1;
            choix1.setText("tigre");
            choix2.setText("explosion");
        }
        else if(nombre==2 && num1!=2 && num2!=2 && num3!=2 && num4!=2 && num5!=2 && num6!=2 && num7!=2 && num8!=2){
            jQ1.setText(question2);
            reponse=reponse2;
            choix1.setText("vendredi");
            choix2.setText("samedi");
        }
         else if(nombre==3 && num1!=3 && num2!=3 && num3!=3 && num4!=3 && num5!=3 && num6!=3 && num7!=3 && num8!=3){
            jQ1.setText(question3);
            reponse=reponse3;
            choix1.setText("oui");
            choix2.setText("non");
        }
         else if(nombre==4 && num1!=4 && num2!=4 && num3!=4 && num4!=4 && num5!=4 && num6!=4 && num7!=4 && num8!=4){
            jQ1.setText(question4);
            reponse=reponse4;
            choix1.setText("France");
            choix2.setText("Autriche");
        }
         else if(nombre==5 && num1!=5 && num2!=5 && num3!=5 && num4!=5 && num5!=5 && num6!=5 && num7!=5 && num8!=5){
            jQ1.setText(question5);
            reponse=reponse5;
            choix1.setText("Mont Blanc");
            choix2.setText("Himalaya");
        }
         else if(nombre==6 && num1!=6 && num2!=6 && num3!=6 && num4!=6 && num5!=6 && num6!=6 && num7!=6 && num8!=6){
            jQ1.setText(question6);
            reponse=reponse6;
            choix1.setText("début");
            choix2.setText("fin");
        }
         else if(nombre==7 && num1!=7 && num2!=7 && num3!=7 && num4!=7 && num5!=7 && num6!=7 && num7!=7 && num8!=7){
            jQ1.setText(question7);
            reponse=reponse7;
            choix1.setText("StarOffice");
            choix2.setText("PcOffice");
        }
         else if(nombre==8 && num1!=8 && num2!=8 && num3!=8 && num4!=8 && num5!=8 && num6!=8 && num7!=8 && num8!=8){
            jQ1.setText(question8);
            reponse=reponse8;
            choix1.setText("Mis-à-jour régulièrement");
            choix2.setText("Disponible");
        }
         else if(nombre==9 && num1!=9 && num2!=9 && num3!=9 && num4!=9 && num5!=9 && num6!=9 && num7!=9 && num8!=9){
         ...
         else if(nombre==10 && num1!=10 && num2!=10 && num3!=10 && num4!=10 && num5!=10 && num6!=10 && num7!=10 && num8!=10){
         ...
         else if(nombre==11 && num1!=11 && num2!=11 && num3!=11 && num4!=11 && num5!=11 && num6!=11 && num7!=11 && num8!=11){
         ...
         else if(nombre==12 && num1!=12 && num2!=12 && num3!=12 && num4!=12 && num5!=12 && num6!=12 && num7!=12 && num8!=12){
         ...
         else if(nombre==13 && num1!=13 && num2!=13 && num3!=13 && num4!=13 && num5!=13 && num6!=13 && num7!=13 && num8!=13){
         ...
         else if(nombre==14 && num1!=14 && num2!=14 && num3!=14 && num4!=14 && num5!=14 && num6!=14 && num7!=14 && num8!=14){
         ...
         else if(nombre==15 && num1!=15 && num2!=15 && num3!=15 && num4!=15 && num5!=15 && num6!=15 && num7!=15 && num8!=15){
         ...
         else if(nombre==16 && num1!=16 && num2!=16 && num3!=16 && num4!=16 && num5!=16 && num6!=16 && num7!=16 && num8!=16){
         ...
         else if(nombre==17 && num1!=17 && num2!=17 && num3!=17 && num4!=17 && num5!=17 && num6!=17 && num7!=17 && num8!=17){
