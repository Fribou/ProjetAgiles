 ...
 * @author davy
 */
public class niv2Q7 extends javax.swing.JFrame {

    /**
     * Creates new form niv2Q7
     */
    ...
    private  void question(){
        ...
        n17=nombre;
        if(nombre==1 && n11!=1 && n12!=1 && n13!=1 && n14!=1 && n15!=1 && n16!=1){
            jQ3.setText(question11);
            reponse=rep11;
        }
        else if(nombre==2 && n11!=2 && n12!=2 && n13!=2 && n14!=2 && n15!=2 && n16!=2){
            jQ3.setText(question12);
            reponse=rep12;
        }
        else if(nombre==3 && n11!=3 && n12!=3 && n13!=3 && n14!=3 && n15!=3 && n16!=3){
            jQ3.setText(question13);
            reponse=rep13;
        }
        else if(nombre==4 && n11!=4 && n12!=4 && n13!=4 && n14!=4 && n15!=4 && n16!=4){
            jQ3.setText(question14);
            reponse=rep14;
        }
        else if(nombre==5 && n11!=5 && n12!=5 && n13!=5 && n14!=5 && n15!=5 && n16!=5){
            jQ3.setText(question15);
            reponse=rep15;
        }
        else if(nombre==6 && n11!=6 && n12!=6 && n13!=6 && n14!=6 && n15!=6 && n16!=6){
            jQ3.setText(question16);
            reponse=rep16;
        }
        else if(nombre==7 && n11!=7 && n12!=7 && n13!=7 && n14!=7 && n15!=7 && n16!=7){
            jQ3.setText(question17);
            reponse=rep17;
        }
        else if(nombre==8 && n11!=8 && n12!=8 && n13!=8 && n14!=8 && n15!=8 && n16!=8){
            jQ3.setText(question18);
            reponse=rep18;
        }
        else if(nombre==9 && n11!=9 && n12!=9 && n13!=9 && n14!=9 && n15!=9 && n16!=9){
            jQ3.setText(question19);
            reponse=rep19;
        }
        else if(nombre==10 && n11!=10 && n12!=10 && n13!=10 && n14!=10 && n15!=10 && n16!=10){
            jQ3.setText(question20);
            reponse=rep20;
        }
        else if(nombre==11 && n11!=11 && n12!=11 && n13!=11 && n14!=11 && n15!=11 && n16!=11){
            jQ3.setText(question21);
            reponse=rep21;
        }
        else if(nombre==12 && n11!=12 && n12!=12 && n13!=12 && n14!=12 && n15!=12 && n16!=12){
            jQ3.setText(question22);
            reponse=rep22;
        }else if(nombre==13 && n11!=13 && n12!=13 && n13!=13 && n14!=13 && n15!=13 && n16!=13){
            jQ3.setText(question23);
            reponse=rep23;
        }else if(nombre==14 && n11!=14 && n12!=14 && n13!=14 && n14!=14 && n15!=14 && n16!=14){
            jQ3.setText(question24);
            reponse=rep24;
        }
        else if(nombre==15 && n11!=15 && n12!=15 && n13!=15 && n14!=15 && n15!=15 && n16!=15){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(niv2Q7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
